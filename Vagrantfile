...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "lerraz/project_rails"
...
$START_CLOUD9_IDE = <<SCRIPT
  ...
  /home/vagrant/.nvm/versions/node/v10.1.0/bin/forever start /home/vagrant/Cloud9IDE/server.js -p 8181 -l 0.0.0.0 -a : -w "/vagrant/ToDoList"
  echo "."
  echo "."
  echo "."
  echo "."
